...
import { insertText, makePath, listToArray, setupDeps, setupTheme } from './helpers';
...
export default async () => {
  ...
  try {
    let indexTemplate = fs.readFileSync(resolve(__dirname, '../indexTemplate.txt'), 'utf8');
    ...
    console.log(chalk.green('Your plugin can be found: ', destinationPath));
  } catch(err) {
